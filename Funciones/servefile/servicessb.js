    ...
    for (totalchecking = 0; totalchecking < totalservices; totalchecking++) {
      ...
      signageboardservice1.get().then(function (doc) {
        if (doc.exists) {
          ...
          storageRef.child('SignageBoard/sb1.jpg').getDownloadURL().then(function (url) {
          ...
          storageRef.child('SignageBoard/sb2.jpg').getDownloadURL().then(function (url) {
          ...
          storageRef.child('SignageBoard/sb3.jpg').getDownloadURL().then(function (url) {
          ...
          storageRef.child('SignageBoard/sb4.jpg').getDownloadURL().then(function (url) {
          ...
          storageRef.child('SignageBoard/sb5.jpg').getDownloadURL().then(function (url) {
          ...
          storageRef.child('SignageBoard/sb6.jpg').getDownloadURL().then(function (url) {
          ...
          storageRef.child('SignageBoard/sb7.jpg').getDownloadURL().then(function (url) {
          ...
          storageRef.child('SignageBoard/sb8.jpg').getDownloadURL().then(function (url) {
          ...
          storageRef.child('SignageBoard/sb9.jpg').getDownloadURL().then(function (url) {
          ...
          storageRef.child('SignageBoard/sb10.jpg').getDownloadURL().then(function (url) {
