...
var signageboardservice1 = db.collection("brandingservice").doc("brandinginfo");
...
var totalServicesRef = db.collection("brandingservice").doc("totalServices");
    ...
    for (totalchecking = 0; totalchecking < totalservices; totalchecking++) {
      ...
      signageboardservice1.get().then(function (doc) {
        if (doc.exists) {
          ...
          storageRef.child('Branding/sb1.jpg').getDownloadURL().then(function (url) {
          ...
          storageRef.child('Branding/sb2.jpg').getDownloadURL().then(function (url) {
          ...
          storageRef.child('Branding/sb3.jpg').getDownloadURL().then(function (url) {
          ...
          storageRef.child('Branding/sb4.jpg').getDownloadURL().then(function (url) {
          ...
          storageRef.child('Branding/sb5.jpg').getDownloadURL().then(function (url) {
          ...
          storageRef.child('Branding/sb6.jpg').getDownloadURL().then(function (url) {
          ...
          storageRef.child('Branding/sb7.jpg').getDownloadURL().then(function (url) {
          ...
          storageRef.child('Branding/sb8.jpg').getDownloadURL().then(function (url) {
          ...
          storageRef.child('Branding/sb9.jpg').getDownloadURL().then(function (url) {
          ...
          storageRef.child('Branding/sb10.jpg').getDownloadURL().then(function (url) {
