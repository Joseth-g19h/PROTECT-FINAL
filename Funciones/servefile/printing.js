...
var signageboardservice1 = db.collection("printingservice").doc("printinginfo");
...
var totalServicesRef = db.collection("printingservice").doc("totalServices");
    ...
    for (totalchecking = 0; totalchecking < totalservices; totalchecking++) {
      ...
      signageboardservice1.get().then(function (doc) {
        if (doc.exists) {
          ...
          storageRef.child('Printing/sb1.jpg').getDownloadURL().then(function (url) {
          ...
          storageRef.child('Printing/sb2.jpg').getDownloadURL().then(function (url) {
          ...
          storageRef.child('Printing/sb3.jpg').getDownloadURL().then(function (url) {
          ...
          storageRef.child('Printing/sb4.jpg').getDownloadURL().then(function (url) {
          ...
          storageRef.child('Printing/sb5.jpg').getDownloadURL().then(function (url) {
          ...
          storageRef.child('Printing/sb6.jpg').getDownloadURL().then(function (url) {
          ...
          storageRef.child('Printing/sb7.jpg').getDownloadURL().then(function (url) {
          ...
          storageRef.child('Printing/sb8.jpg').getDownloadURL().then(function (url) {
          ...
          storageRef.child('Printing/sb9.jpg').getDownloadURL().then(function (url) {
          ...
          storageRef.child('Printing/sb10.jpg').getDownloadURL().then(function (url) {
